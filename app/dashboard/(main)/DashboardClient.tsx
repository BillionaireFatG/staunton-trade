...
export default function DashboardClient({ initialDeals, stats }: DashboardClientProps) {
  ...
  return (
    <div className="space-y-6 min-w-0 w-full">
      {/* Congo Trade Environment Access */}
      <Link href="/dashboard/congo">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-lg bg-primary flex items-center justify-center">
                  <Globe2 size={24} className="text-primary-foreground" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Enter Congo Trade Environment</h3>
                  <p className="text-sm text-muted-foreground">
                    DRC National Commodity Exchange - Ministry of Congo Demo Platform
                  </p>
                </div>
              </div>
              <Button size="lg">
