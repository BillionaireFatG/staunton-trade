...
export default function TrackingPage() {
  ...
  const shipmentsData = getShipments(environment);
  
  const mockTrackingData = shipmentsData.map(s => ({
    id: s.id,
  ...
  const [selectedShipment, setSelectedShipment] = useState(mockTrackingData[0] || null);
  ...
  if (!selectedShipment || mockTrackingData.length === 0) {
    return (
